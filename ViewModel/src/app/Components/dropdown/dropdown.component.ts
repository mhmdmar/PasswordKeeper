    ...
    template: `
        <div ngbDropdown class="d-inline-block">
            <button
                ...
                class="invisibleBtn dropdownBtn app-text-font"
                [ngClass]="hideShowMoreBtn()"
                id="dropdown"
                ngbDropdownToggle
            >
                <span [attr.test-id]="template.testId" class="app-text-font"></span>
            ...
            <div ngbDropdownMenu aria-labelledby="dropdown" *ngIf="template.options">
                <button
                    ngbDropdownItem
                    class="invisibleBtn clickable"
                    *ngFor="let option of template.options"
                    [title]="option.title || ''"
                    (click)="option.callback()"
                >
                    <app-icon *ngIf="option.icon" [icon]="option.icon"></app-icon>
                    <span
                        class="app-text-font-black"
                        *ngIf="option.value"
